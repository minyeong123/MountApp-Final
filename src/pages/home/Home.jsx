                            ...
                            <MaskedView
                                ...
                                maskElement={
                                    <View style={{ flex: 1, backgroundColor: 'transparent', justifyContent: 'center' }}>
                                        <Text style={{ fontSize: 25, fontWeight: '900', includeFontPadding: false, textAlignVertical: 'center' }}>
                                            MountApp
                                        </Text>
                                    </View>
                                }
                            >
                                <LinearGradient colors={['#16a34a', '#2563eb']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={{ flex: 1 }} />
                            </MaskedView>
                        </View>
