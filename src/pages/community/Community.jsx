        ...
        >
            <View className="flex-row items-start mb-4">
                <View className="flex-1 mr-4">
                    <Text className="text-gray-400 text-[11px] mb-1">{item.category || "일반"}</Text>
                    <Text className="font-bold text-gray-900 mb-1" numberOfLines={1}>{item.title}</Text>
                    <Text className="text-gray-500 text-[13px] leading-5" numberOfLines={2}>{item.postContents || item.comment}</Text>
                </View>
